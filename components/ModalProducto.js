    ...
    return (
        <div className="md:flex gap-10">
            ...
            <div className="md:w-2/3">
                ...
                <button type="button" className="bg-indigo-600 transition-colors hover:bg-indigo-800 px-5 py-2 mt-5 text-white font-bold uppercase rounded" onClick={() => handleAgregarPedido({...producto, cantidad})}>{edicion ? 'Guardar Cambios' : 'Añadir al pedido'}</button>
            </div>
        </div>
    )
}
